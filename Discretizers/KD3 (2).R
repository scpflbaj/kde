      ...
      if (length(args)==0) {
        RunFile           = "../../../data/Database.14.csv" # ORIGINAL: args[1]
        RUNINFO           = read.csv(RunFile)
        #InputFolder       = "../../../data/SIMLNL00/Beta.03/"# ORIGINAL
        InputFolder       = ""# TEST
        # 
        PTrainFile        = "P14.02.02.train.arff" # ORIGINAL: args[3]
        PTestFile         = "P14.02.02.test.arff"  # ORIGINAL: args[4]
        RTrainFile        = "R14.02.02.train.arff" # ORIGINAL: args[5]
        RTestFile         = "R14.02.02.test.arff" # ORIGINAL: args[6]
